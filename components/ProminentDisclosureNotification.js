...
const ProminentDisclosureNotification = ({ visible, onAgree, onSkip }) => {
      ...
      <ScrollView>
        <View style={styles.modalContent}>
          <View style={styles.titleContainer}>
            ...
            />
            <Text style={styles.title}>{t("notification disclosure")}</Text>
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.description}>
              {t("notification disclosure desc")}
            </Text>
          </View>
          <Image
...
export default ProminentDisclosureNotification;

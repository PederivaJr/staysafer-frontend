...
const ProminentDisclosureLocation = ({ visible, onAgree, onSkip }) => {
      ...
      <ScrollView>
        <View style={styles.modalContent}>
          <View style={styles.titleContainer}>
            <MaterialCommunityIcons name="map-marker-alert-outline" size={36} color={colors.darkerGrey} />
            <Text style={styles.title}>{t("location disclosure")}</Text>
          </View>
          <View style={styles.textContainer}>
            <Text style={styles.description}>
            {t("location disclosure desc")}
            </Text>
          </View>
          <Image
...
export default ProminentDisclosureLocation;

      ...
      },
      {
        ...
        onPress: async () => {
          ...
          try {
            ...
            if (result.ok) {
              // The real-time evacuation hook will automatically update the evacuation state
              // We still update other data that's not real-time
              ...
              // Note: evacuation state will be updated by useEvacuationStatus hook
              console.log("Evacuation created, real-time update will follow");

              Toast.show(
                eventType === "drill"
                  ? t("toast drill started")
                  : t("toast evacuation started"),
